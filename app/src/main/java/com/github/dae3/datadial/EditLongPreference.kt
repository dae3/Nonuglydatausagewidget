...
open class EditLongPreference(context: Context?, attrs: AttributeSet?) : DialogPreference(context, attrs) {
    ...
    init {
        ...
        minValue = attrs.getAttributeLongValue("https://github.com/dae3", "minimum", Long.MIN_VALUE)
        maxValue = attrs.getAttributeLongValue("https://github.com/dae3", "maximum", Long.MAX_VALUE)
        stepValue = attrs.getAttributeLongValue("https://github.com/dae3", "step", Long.MIN_VALUE+1)   
