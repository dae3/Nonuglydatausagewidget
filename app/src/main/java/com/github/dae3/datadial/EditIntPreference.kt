...
//        isPersistent = false
        ...
        minValue = attrs.getAttributeIntValue("https://github.com/dae3", "minimum", minValue)
        maxValue = attrs.getAttributeIntValue("https://github.com/dae3", "maximum", maxValue)
        stepValue = attrs.getAttributeIntValue("https://github.com/dae3", "step", stepValue)
