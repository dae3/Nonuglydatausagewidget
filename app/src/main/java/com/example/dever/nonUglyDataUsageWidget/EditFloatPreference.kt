...
open class EditFloatPreference(context: Context?, attrs: AttributeSet?) : DialogPreference(context, attrs) {
    ...
    init {
        ...
        minValue = attrs.getAttributeFloatValue("http://dever.example.com", "minimum", Float.MIN_VALUE)
        maxValue = attrs.getAttributeFloatValue("http://dever.example.com", "maximum", Float.MAX_VALUE)
        stepValue = attrs.getAttributeFloatValue("http://dever.example.com", "step", Float.MIN_VALUE+1)
