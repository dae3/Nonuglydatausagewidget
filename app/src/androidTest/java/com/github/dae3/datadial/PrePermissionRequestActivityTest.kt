...
//        device.executeShellCommand("pm clear com.example.dever.nonUglyDataUsageWidget")
    ...
    fun setup() {
        ...
        device.executeShellCommand("pm revoke com.github.dae3.datadial android.permission.READ_PHONE_STATE")
        ...
        device.findObject(By.text("Data Dial")).click()
    ...
    fun firstRunUserGrantsAllPermissions() {
        ...
        device.pressBack()
        device.pressBack()
        device.wait(Until.hasObject(By.text("Data Dial")), waitTimeout)
